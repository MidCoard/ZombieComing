...
public class Place_1_12 extends PathfinderGoal implements ZombiePlaceBlock {

	private static List<Material> maters;

	private final EntityZombie zombie;

	public Place_1_12(final Object obj) {
	...
	public boolean a() {
		...
		return z.getEquipment() != null && z.getEquipment().getItemInHand() != null
				...
				&& Place_1_12.maters.contains(z.getEquipment().getItemInHand().getType());
	}
